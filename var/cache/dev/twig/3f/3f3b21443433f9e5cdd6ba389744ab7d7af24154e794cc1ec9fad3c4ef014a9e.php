...
class __TwigTemplate_ec52f00dddea840aae4371aa1892e66681b652066e902d0e67f1256daacce343 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t} else {
\t\t\t\t\t\tthis.collection.filterParameters.isEnabled = null;
...
\t\t\t\t\t'isEnabled/:status(/search/:query)(/page/:number)(/sort/:sortField)(/direction/:order)' : 'filterCustomerByStatus',
...
\t\t\t\t\t\tquery = query.replace(/\\+/g,' ');
                    if(status == \"starred\") {
                        ...
                        customerCollection.filterParameters.isEnabled = null;
        ...
        echo "\");
                        ...
                        customerCollection.filterParameters.isEnabled = status;
...
\t</script>
{% endblock %}
", "@UVDeskCoreFramework/Customers/listSupportCustomers.html.twig", "/home/users/vipin.shrivastava/www/html/uvdesk_new_18/vendor/uvdesk/core-framework/Resources/views/Customers/listSupportCustomers.html.twig");
    }
}
