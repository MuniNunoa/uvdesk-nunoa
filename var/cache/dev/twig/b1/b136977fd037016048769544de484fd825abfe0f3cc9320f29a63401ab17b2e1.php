...
class __TwigTemplate_cd16a62e1fa00786854f858df38252c60f38d4611b57314ee91a0bdad5133eb2 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\tmsg: \"";
        // line 153
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("This field contain maximum 60 charectures."), "html", null, true);
        echo "\"
\t\t\t\t\t}],
                    'sortOrder': {
                        pattern: '^[0-9]*\$',
...
\t\t});
\t</script>
{% endblock %}", "@UVDeskSupportCenter/Staff/Category/categoryForm.html.twig", "/home/users/vipin.shrivastava/www/html/uvdesk_new_18/vendor/uvdesk/support-center-bundle/Resources/views/Staff/Category/categoryForm.html.twig");
    }
}
