...
class __TwigTemplate_5a91e0ee9081c6cbc8841db16bed5701bc4554fbfba34b90d245d3403f310386 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\tmsg: \"";
        // line 84
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("This field contain maximum 18 charectures."), "html", null, true);
        echo "\"
\t\t\t\t\t}],
\t\t\t\t\t'description': {
\t\t\t\t\t\trequired: true,
...
\t\t});
\t</script>
{% endblock %}", "@UVDeskSupportCenter/Staff/Folders/updateFolder.html.twig", "/home/users/vipin.shrivastava/www/html/uvdesk_new_18/vendor/uvdesk/support-center-bundle/Resources/views/Staff/Folders/updateFolder.html.twig");
    }
}
