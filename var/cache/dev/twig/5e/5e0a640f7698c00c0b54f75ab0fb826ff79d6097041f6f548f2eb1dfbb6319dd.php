...
class __TwigTemplate_cd8a9a65cb04f1da195b1faf538c95b1f2b1c0c802eba548b8021b16a115d841 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t<form method=\"post\" action=\"\" id=\"user-form\" enctype=\"multipart/form-data\">
        ...
        echo "</a>
                ...
                <div class=\"uv-tab-view\" id=\"permission\">
                    ";
        // line 266
        if (!twig_in_filter("ROLE_SUPER_ADMIN", twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 266, $this->source); })()), "roles", [], "any", false, false, false, 266))) {
            // line 267
            echo "                        <!-- Field -->
                        <div class=\"uv-element-block\">
                            <label class=\"uv-field-label\">";
...
\t\t\t\t\t    <div class=\"uv-image-upload-brick {% if isHaveImage %}uv-on-drop-shadow{% endif %}\" {% if isHaveImage %}style=\"border-color: transparent;\"{% endif %}>
                    ...
                    <div class=\"uv-element-block\">
                        <label>
                            <div class=\"uv-checkbox\">
                                <input type=\"checkbox\" name=\"user_form[isActive]\" value=\"{{ userDetails and userDetails.isEnabled ? 1 : 0 }}\" {{ userDetails and userDetails.isEnabled ? 'checked' : '' }}>
                                <span class=\"uv-checkbox-view\"></span>
                            </div>
...
\t</script>
{% endblock %}
", "@UVDeskCoreFramework/Agents/updateSupportAgent.html.twig", "/home/users/vipin.shrivastava/www/html/uvdesk_new_18/vendor/uvdesk/core-framework/Resources/views/Agents/updateSupportAgent.html.twig");
    }
}
