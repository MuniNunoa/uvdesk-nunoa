...
class __TwigTemplate_0a6d480a06d9a374fc55a0dd6616bdcfef9e1a29abef98e9ea088621f9a5e55d extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t<span class=\"uv-checkbox-label\">";
        // line 100
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Delete from Inbox"), "html", null, true);
        echo "</span>
\t\t\t\t\t</label>
\t\t\t\t</div>
...
\t</script>
{% endblock %}
", "@UVDeskMailbox/manageConfigurations.html.twig", "/home/users/vipin.shrivastava/www/html/uvdesk_new_18/vendor/uvdesk/mailbox-component/Resources/views/manageConfigurations.html.twig");
    }
}
