...
class __TwigTemplate_ab2f86e88786a390a048f688418ae490fd3ab7fa1217de328cb1494f08910e42 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"uv-aside\" {% if app.request.cookies and app.request.cookies.get('uv-asideView') %}style=\"display: none;\"{% endif %}>
    ...
    {% endif %}
</div>", "@UVDeskSupportCenter/Templates/solutionLeftSidebar.html.twig", "/home/users/vipin.shrivastava/www/html/uvdesk_new_18/vendor/uvdesk/support-center-bundle/Resources/views/Templates/solutionLeftSidebar.html.twig");
    }
}
